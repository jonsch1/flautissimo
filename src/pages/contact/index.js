      ...
      <Layout>
        <section className="section">
          <div className="container">
            ...
            <div className="map"><iframe id="iframemap" src='https://www.google.com/maps/embed/v1/place?key=AIzaSyBD_fqDXZj27CQ3Rehaxc2MxxG247Ae7xM&q=Krugenofen%2019%2C%2052066%20Aachen+(Musikhaus-Aachen)' width='420' height='400' frameBorder='0' className='uwpgmap' title="Krugenofen 19, 52066 Aachen"></iframe> </div>           
